...
public class LunarEssenceEntityBlock extends BlockEntity{

    public LunarEssenceEntityBlock(BlockPos pPos, BlockState pBlockState) {
        super(ModBlockEntites.LUNAR_ESSENCE_BLOCK_ENTITY.get(), pPos, pBlockState);
    }
    ...
    public static void tick(Level level, BlockPos pos, BlockState state) {
        if (level.isClientSide) {
            ...
            level.addParticle(ModParticles.LUNAR_ESSENCE_PARTICLE.get(), x, y, z, 0.0, 0.0, 0.0);
        }
    }
