...
public class WaterEssenceBottleParticle extends TextureSheetParticle {
    ...
    protected WaterEssenceBottleParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            int startHex = 0x0b107c;
            int endHex   = 0x87e1f4;
            return new WaterEssenceBottleParticle(level, x, y, z, this.sprite, dx, dy, dz, startHex, endHex);
        }
    }
}
