...
public class FireEssenceBottleParticle extends TextureSheetParticle {
    ...
    protected FireEssenceBottleParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            int endHex   = 0xff8c76;
            return new FireEssenceBottleParticle(level, x, y, z, this.sprite, dx, dy, dz, startHex, endHex);
        }
    }
}
