...
public class NatureEssenceBottleParticle extends TextureSheetParticle {
    ...
    protected NatureEssenceBottleParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            int endHex   = 0xe2f23b;
            return new NatureEssenceBottleParticle(level, x, y, z, this.sprite, dx, dy, dz, startHex, endHex);
        }
    }
}
