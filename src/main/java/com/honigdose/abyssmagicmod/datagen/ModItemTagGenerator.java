...
public class ModItemTagGenerator extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        this.tag(ModTags.Items.CRYSTALS)
                ...
                .add(Item.byBlock(ModBlocks.NATUR_CRYSTAL.get()))
                .add(Item.byBlock(ModBlocks.BABY_NATUR_CRYSTAL.get()))
                .add(Item.byBlock(ModBlocks.SMALL_NATUR_CRYSTAL.get()))
                .add(Item.byBlock(ModBlocks.LARGE_NATUR_CRYSTAL.get()))
                .add(Item.byBlock(ModBlocks.NATUR_CRYSTAL_BLOCK.get()))
                .add(ModItems.NATUR_CRYSTAL_SHARD.get())
