...
public class FireEssenceEntityBlock extends BlockEntity{

    public FireEssenceEntityBlock(BlockPos pPos, BlockState pBlockState) {
        super(ModBlockEntites.FIRE_ESSENCE_BLOCK_ENTITY.get(), pPos, pBlockState);
    }
    ...
    public static void tick(Level level, BlockPos pos, BlockState state) {
        if (level.isClientSide) {
            ...
            level.addParticle(ModParticles.FIRE_ESSENCE_PARTICLE.get(), x, y, z, 0.0, 0.0, 0.0);
        }
    }
