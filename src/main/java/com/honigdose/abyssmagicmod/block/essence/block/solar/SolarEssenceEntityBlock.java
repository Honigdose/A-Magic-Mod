...
public class SolarEssenceEntityBlock extends BlockEntity{

    public SolarEssenceEntityBlock(BlockPos pPos, BlockState pBlockState) {
        super(ModBlockEntites.SOLAR_ESSENCE_BLOCK_ENTITY.get(), pPos, pBlockState);
    }
