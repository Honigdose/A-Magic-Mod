...
public class SmallCrystalClusterBlock extends AmethystClusterBlock {
    public SmallCrystalClusterBlock(float p_313148_, float p_309607_, Properties p_152017_) {
