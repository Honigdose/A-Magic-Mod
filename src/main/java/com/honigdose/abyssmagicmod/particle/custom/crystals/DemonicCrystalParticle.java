...
public class DemonicCrystalParticle extends TextureSheetParticle {
    private static final Random RANDOM = new Random();

    private final int startHex;
    private final int endHex;

    protected DemonicCrystalParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            int startHex = 0x2b0202;
            int endHex   = 0x2e0017;
            return new DemonicCrystalParticle(level, x, y, z, this.sprite, dx, dy, dz, startHex, endHex);
        }
    }
