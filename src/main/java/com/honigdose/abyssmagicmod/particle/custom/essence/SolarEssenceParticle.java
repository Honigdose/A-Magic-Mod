...
public class SolarEssenceParticle extends TextureSheetParticle {
    ...
    protected SolarEssenceParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            int endHex = 0xd42300;
            return new SolarEssenceParticle(level, x, y, z, this.sprite, dx, dy, dz, startHex, endHex);
        }
    }
