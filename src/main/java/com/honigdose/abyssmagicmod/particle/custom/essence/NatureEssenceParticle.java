...
public class NatureEssenceParticle extends TextureSheetParticle {
    ...
    protected NatureEssenceParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            int startHex = 0xfff130;
            int endHex = 0x027540;
            return new NatureEssenceParticle(level, x, y, z, this.sprite, dx, dy, dz, startHex, endHex);
        }
    }
