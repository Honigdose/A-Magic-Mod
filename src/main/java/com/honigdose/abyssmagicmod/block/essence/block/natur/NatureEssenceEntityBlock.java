...
public class NatureEssenceEntityBlock extends BlockEntity{

    public NatureEssenceEntityBlock(BlockPos pPos, BlockState pBlockState) {
        super(ModBlockEntites.NATURE_ESSENCE_BLOCK_ENTITY.get(), pPos, pBlockState);
    }
