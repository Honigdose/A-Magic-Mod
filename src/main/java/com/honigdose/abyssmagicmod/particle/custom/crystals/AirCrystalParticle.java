...
public class AirCrystalParticle extends TextureSheetParticle {
    private static final Random RANDOM = new Random();

    private final int startHex;
    private final int endHex;

    protected AirCrystalParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            int startHex = 0xb5ffe5;
            int endHex   = 0xd5d4ff;
            return new AirCrystalParticle(level, x, y, z, this.sprite, dx, dy, dz, startHex, endHex);
        }
    }
