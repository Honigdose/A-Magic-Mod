...
public class VerySmallCrystalClusterBlock extends AmethystClusterBlock {
    public VerySmallCrystalClusterBlock(float p_313148_, float p_309607_, Properties p_152017_) {
    ...
    public void animateTick(BlockState state, Level level, BlockPos pos, RandomSource random) {
        if (random.nextFloat() < 0.1f) {
            ...
            if (this == ModBlocks.VERY_SMALL_ARCANA_CRYSTAL.get()) {
                particleType = ModParticles.ARCANA_CRYSTAL_PARTICLE.get();
            } else if (this == ModBlocks.VERY_SMALL_FIRE_CRYSTAL.get()) {
                particleType = ModParticles.FIRE_CRYSTAL_PARTICLE.get();
            } else if (this == ModBlocks.VERY_SMALL_AIR_CRYSTAL.get()) {
                particleType = ModParticles.AIR_CRYSTAL_PARTICLE.get();
            } else if (this == ModBlocks.VERY_SMALL_NATURE_CRYSTAL.get()) {
                particleType = ModParticles.NATUR_CRYSTAL_PARTICLE.get();
            } else if (this == ModBlocks.VERY_SMALL_WATER_CRYSTAL.get()) {
                particleType = ModParticles.WATER_CRYSTAL_PARTICLE.get();
            } else if (this == ModBlocks.VERY_SMALL_SOLAR_CRYSTAL.get()) {
                particleType = ModParticles.SOLAR_CRYSTAL_PARTICLE.get();
            } else if (this == ModBlocks.VERY_SMALL_LUNAR_CRYSTAL.get()) {
                particleType = ModParticles.LUNAR_CRYSTAL_PARTICLE.get();
            } else if (this == ModBlocks.VERY_SMALL_VOID_CRYSTAL.get()) {
                particleType = ModParticles.VOID_CRYSTAL_PARTICLE.get();
            } else if (this == ModBlocks.VERY_SMALL_DEMONIC_CRYSTAL.get()) {
                particleType = ModParticles.DEMONIC_CRYSTAL_PARTICLE.get();
            } else if (this == ModBlocks.VERY_SMALL_CELESTIAL_CRYSTAL.get()) {
