...
public class WaterEssenceEntityBlock extends BlockEntity{

    public WaterEssenceEntityBlock(BlockPos pPos, BlockState pBlockState) {
        super(ModBlockEntites.WATER_ESSENCE_BLOCK_ENTITY.get(), pPos, pBlockState);
    }
    ...
    public static void tick(Level level, BlockPos pos, BlockState state) {
        if (level.isClientSide) {
            ...
            level.addParticle(ModParticles.WATER_ESSENCE_PARTICLE.get(), x, y, z, 0.0, 0.0, 0.0);
        }
    }
