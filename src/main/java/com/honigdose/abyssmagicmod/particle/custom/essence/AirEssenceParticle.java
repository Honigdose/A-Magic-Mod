...
public class AirEssenceParticle extends TextureSheetParticle {
    ...
    protected AirEssenceParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            int endHex = 0x5729e3;
            return new AirEssenceParticle(level, x, y, z, this.sprite, dx, dy, dz, startHex, endHex);
        }
    }
