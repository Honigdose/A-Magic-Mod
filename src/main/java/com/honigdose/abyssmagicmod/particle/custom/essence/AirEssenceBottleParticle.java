...
public class AirEssenceBottleParticle extends TextureSheetParticle {
    ...
    protected AirEssenceBottleParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            int startHex = 0x6f5a92;
            int endHex   = 0xb7f7d6;
            return new AirEssenceBottleParticle(level, x, y, z, this.sprite, dx, dy, dz, startHex, endHex);
        }
    }
}
