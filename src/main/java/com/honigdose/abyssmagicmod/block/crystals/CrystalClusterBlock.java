...
public class CrystalClusterBlock extends AmethystClusterBlock {
    public CrystalClusterBlock(float p_313148_, float p_309607_, Properties p_152017_) {
