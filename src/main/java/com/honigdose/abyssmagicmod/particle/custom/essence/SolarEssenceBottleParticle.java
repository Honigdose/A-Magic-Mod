...
public class SolarEssenceBottleParticle extends TextureSheetParticle {
    ...
    protected SolarEssenceBottleParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            int startHex = 0xebc41b;
            int endHex   = 0x7c0c0b;
            return new SolarEssenceBottleParticle(level, x, y, z, this.sprite, dx, dy, dz, startHex, endHex);
        }
    }
}
