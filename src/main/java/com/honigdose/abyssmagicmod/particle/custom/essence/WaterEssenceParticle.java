...
public class WaterEssenceParticle extends TextureSheetParticle {
    ...
    protected WaterEssenceParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            int endHex = 0x0a0073;
            return new WaterEssenceParticle(level, x, y, z, this.sprite, dx, dy, dz, startHex, endHex);
        }
    }
